      ...
      <div className='destaque'>
        ...
        <YouTube videoId={youtubeVideoId} opts={youtubePlayerOptions} />
                ...
                <div className="col-12 col-xxl-4 col-sm-5 text-start">
                    ...
                    <hr />
                   <p>By: <b className='ms-2'>{projeto.nome}</b> <br />
                   E-mail: <b className='ms-2'>{projeto.email}</b>
                   </p>
                   <br />
                   <p>
                    <span style={{textDecoration:'underline'}}>About the project:</span> <br />
                    {projeto.descricao}
                   </p>
                   <br />
                   <br />
                   <span style={{textDecoration:'underline'}}>Views:</span> <i className="bi bi-eye"></i> <br />
