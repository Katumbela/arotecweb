  ...
  return (
    <div className="w-100">
      ...
      <center className="py-5 my-auto" style={{ zIndex: '99999999' }}>
        ...
        <br /><br />
        <button style={{borderColor:'#a2d9ff', color:'#a2d9ff'}} className="btn rounded-3 btn-outline-primary"><NavLink to={'/okupalenda/game'} className={'navlink'}>Start The Game</NavLink></button>
      </center>
